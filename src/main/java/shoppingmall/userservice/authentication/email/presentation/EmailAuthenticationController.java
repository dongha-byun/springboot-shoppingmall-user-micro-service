package shoppingmall.userservice.authentication.email.presentation;
...
import shoppingmall.userservice.authentication.email.application.EmailAuthenticationService;
import shoppingmall.userservice.authentication.email.application.dto.EmailAuthenticationInfo;
import shoppingmall.userservice.authentication.email.presentation.request.AuthenticationMailRequest;
import shoppingmall.userservice.authentication.email.presentation.request.AuthenticationRequest;
import shoppingmall.userservice.authentication.email.presentation.response.EmailAuthenticationSuccessResponse;
